...
INSERT INTO shopapp_books (slug, author_id, title, img, description, stock, price, read, language, original_language) VALUES('harry-potter-and-the-philosophers-stone', 8, 'Harry Potter and the Philosopher''s Stone','harry-potter-philosophers-stone.jpg', 'Harry Potter and the Philosopher''s Stone is the first novel in the Harry Potter series written by British author J.K. Rowling. The story follows Harry Potter, a young wizard who discovers his magical heritage as he makes close friends and a few enemies in his first year at the Hogwarts School of Witchcraft and Wizardry.', 200, 45, false, 'English', 'English');
INSERT INTO shopapp_books (slug, author_id, title, img, description, stock, price, read, language, original_language) VALUES('harry-potter-and-the-chamber-of-secrets', 8, 'Harry Potter and the Chamber of Secrets','harry-potter-chamber-secrets.jpg', 'Harry Potter and the Chamber of Secrets is the second novel in the Harry Potter series written by British author J.K. Rowling. The plot follows Harry''s second year at Hogwarts as he and his friends investigate a dark mystery that has been terrorizing the school.', 200, 45, false, 'English', 'English');
INSERT INTO shopapp_books (slug, author_id, title, img, description, stock, price, read, language, original_language) VALUES('harry-potter-and-the-prisoner-of-azkaban', 8, 'Harry Potter and the Prisoner of Azkaban','harry-potter-prisoner-azkaban.jpg', 'Harry Potter and the Prisoner of Azkaban is the third novel in the Harry Potter series written by British author J.K. Rowling. The book follows Harry Potter, a young wizard, in his third year at Hogwarts School of Witchcraft and Wizardry. Along with friends Ronald Weasley and Hermione Granger, Harry investigates Sirius Black, an escaped prisoner from Azkaban who they believe is one of Lord Voldemort''s old allies.', 200, 50, false, 'English', 'English');

INSERT INTO shopapp_books (slug, author_id, title, img, description, stock, price, read, language, original_language) VALUES('harry-potter-and-the-goblet-of-fire', 8, 'Harry Potter and the Goblet of Fire','harry-potter-goblet-fire.jpg', 'Harry Potter and the Goblet of Fire is the fourth book in the Harry Potter series by J.K. Rowling. The story follows Harry''s participation in the Triwizard Tournament, a dangerous magical competition, and the rise of Lord Voldemort.', 250, 60, false, 'English', 'English');
